...
import am.immodule.Common.IMUIHelper;
import am.immodule.Common.Logger;
import am.immodule.Common.PinYin;
...
import am.immodule.IMBuilders.IMGroup;
import am.immodule.Model.Beans.Util.EntityChangeEngine;
import am.immodule.Model.Evens.GroupEvent;
...
public class IMGroupManager extends IMManager {
    ...
    private void loadSessionGroupInfo(){
        logger.d("group#loadSessionGroupInfo");
