...
import am.immodule.IMBuilders.IMLogin;
...
public class IMLoginManager extends IMManager {
    ...
    public void login(String userName, String password) {
        logger.d("login#login -> userName:%s", userName);

        //test 使用
        LoginSp.SpLoginIdentity identity = LoginSp.instance().getLoginIdentity(); /** 目前这行只做判断所用 */
        ...
        imSocketManager.reqMsgServerAddrs(); /** 登陆入口函数 */
    }
